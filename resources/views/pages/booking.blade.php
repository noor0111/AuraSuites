...
@section('content')
                    ...
                    <div class="card shadow sticky-top" style="top: 20px;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-2">
                                <button class="btn btn-warning btn-lg" onclick="proceedToConfirmation()"
    ...
    <script>
        ...
        function removeBooking(bookingId) {
            ...
            const bookingToRemove = bookings.find(booking => booking.bookingId === bookingId);
            ...
            // Reload the page immediately to update everything
        ...
        function proceedToConfirmation() {
            ...
            if (!checkInDate || !checkOutDate) {
                ...
                if (!checkInDate) {
                    checkInField.setCustomValidity('Please select check-in date');
                    checkInField.reportValidity();
                }
                const checkOutField = document.getElementById('checkOutDate');
                if (!checkOutDate) {
                    checkOutField.setCustomValidity('Please select check-out date');
        ...
        `;
            ...
            // After successful booking, redirect to thank you page
